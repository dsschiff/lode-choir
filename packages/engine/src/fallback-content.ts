...
export const FALLBACK_ROUTES: readonly RouteDefinition[] = [
  { id: 'glass-vein', title: 'The Glass Vein', kind: 'vein', focusCrew: 'orin', description: 'A brittle ore seam vibrates under the drill.', storyLead: 'The vibration matches Orison\'s internal signal.', rewardText: '3 alloy and 1 Heart Note.', hazardText: 'Sharp fragments damage the hull.', baseRewards: { alloy: 3 }, hazard: 2, noteProgress: 1, storyTag: 'vein' },
  { id: 'choir-well', title: 'Choir Well', kind: 'rift', focusCrew: 'sable', description: 'A deep bore repeats crew radio calls.', storyLead: 'The calls use voices the crew has not recorded yet.', rewardText: '3 lumen and 1 Heart Note.', hazardText: 'The signal increases strain.', baseRewards: { lumen: 3 }, hazard: 3, noteProgress: 1, storyTag: 'song' },
  { id: 'pilgrim-cache', title: 'Pilgrim Cache', kind: 'refuge', focusCrew: 'mara', description: 'An old shelter still contains supplies.', storyLead: 'Mara found a current crew name in its old rescue ledger.', rewardText: '3 provisions and 1 alloy.', hazardText: 'Its pressure seals are unstable.', baseRewards: { provisions: 3, alloy: 1 }, hazard: 1, noteProgress: 0, storyTag: 'pilgrim' },
  { id: 'iron-orchard', title: 'Iron Orchard', kind: 'vein', focusCrew: 'tamsin', description: 'Branching ore fills a vacuum chamber.', storyLead: 'The branches are growing toward Orison rather than away from the drill.', rewardText: '4 alloy.', hazardText: 'Cut branches move under pressure.', baseRewards: { alloy: 4 }, hazard: 3, noteProgress: 0, storyTag: 'vein' },
  { id: 'saint-engine', title: 'Engine of Saint Varo', kind: 'ruin', focusCrew: 'orin', description: 'An abandoned engine still has power.', storyLead: 'Orin thinks its control record explains why Orison woke the crew.', rewardText: '2 alloy, 2 lumen, and 1 Heart Note.', hazardText: 'Its flywheel starts without warning.', baseRewards: { alloy: 2, lumen: 2 }, hazard: 2, noteProgress: 1, storyTag: 'ruin' },
  { id: 'blue-quiet', title: 'The Blue Quiet', kind: 'refuge', focusCrew: 'sable', description: 'A sheltered cavern blocks the moon signal.', storyLead: 'It is the only place where Sable cannot hear the deleted minute repeating.', rewardText: '4 provisions.', hazardText: 'No immediate hazard.', baseRewards: { provisions: 4 }, hazard: 0, noteProgress: 0, storyTag: 'quiet' },
  { id: 'split-canticle', title: 'Split Canticle', kind: 'rift', focusCrew: 'sable', description: 'Two Heart-Lode signals share one fault.', storyLead: 'One signal names the crew; the other names the dead.', rewardText: '2 lumen and 1 Heart Note.', hazardText: 'The wrong signal overloads Orison.', baseRewards: { lumen: 2 }, hazard: 4, noteProgress: 1, storyTag: 'song' },
  { id: 'buried-market', title: 'Buried Market', kind: 'ruin', focusCrew: 'mara', description: 'A sealed market contains mixed supplies.', storyLead: 'Its last transaction records the first company selling Orison as equipment.', rewardText: '2 provisions, 2 alloy, and 1 lumen.', hazardText: 'Automated defenses remain active.', baseRewards: { provisions: 2, alloy: 2, lumen: 1 }, hazard: 2, noteProgress: 0, storyTag: 'ruin' },
  { id: 'heartward-fault', title: 'Heartward Fault', kind: 'rift', focusCrew: 'orin', description: 'A collapsing shaft leads toward the Heart-Lode.', storyLead: 'The signal below has stopped calling Orison a machine.', rewardText: '2 alloy, 2 lumen, and 2 Heart Notes.', hazardText: 'Structural collapse is likely.', baseRewards: { alloy: 2, lumen: 2 }, hazard: 5, noteProgress: 2, storyTag: 'heart' },
];
